...
import { Server as Server$1, IncomingMessage, ServerResponse } from 'http';
...
declare type RouterOptions = Exclude<RouterOptions$1, 'history' | 'routes'>;
/**
 * Only JSON serializable router options are configurable from nuxt config
 */
declare type RouterConfigOptions = Pick<RouterOptions, 'linkActiveClass' | 'linkExactActiveClass' | 'end' | 'sensitive' | 'strict'>;
...
interface ImportPresetWithDeperection extends Preset {
    /**
...
interface PublicRuntimeConfig extends Record<string, any> {
}
interface PrivateRuntimeConfig extends PublicRuntimeConfig {
}
declare type _RuntimeConfig = PublicRuntimeConfig & Partial<PrivateRuntimeConfig>;
interface RuntimeConfig extends _RuntimeConfig {
    [key: string]: any;
}
...
declare const _default: {
    ...
    privateRuntimeConfig: {};
    publicRuntimeConfig: {
        $resolve: (val: Record<string, any>, get: any) => {
            app: any;
        };
    };
    vue: {
...
export { AutoImportsOptions, Component, ComponentsDir, ComponentsOptions, ImportPresetWithDeperection, MetaObject, ModuleContainer, ModuleDefinition, ModuleMeta, ModuleOptions, Nuxt, NuxtApp, NuxtCompatibility, NuxtCompatibilityIssue, NuxtCompatibilityIssues, NuxtConfig, _default as NuxtConfigSchema, NuxtHookName, NuxtHooks, NuxtLayout, NuxtMiddleware, NuxtModule, NuxtOptions, NuxtPage, NuxtPlugin, NuxtPluginTemplate, NuxtTemplate, PrivateRuntimeConfig, PublicRuntimeConfig, RouterConfigOptions, RouterOptions, RuntimeConfig, ScanDir, TSReference };
